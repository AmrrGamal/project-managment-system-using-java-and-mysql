 ...
 * @author amr
 */
public class TmSendPenlaties extends javax.swing.JFrame {

    /**
     * Creates new form Tmpenlaties
     */
    public TmSendPenlaties() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(650, 459));
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TmSendPenlaties.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TmSendPenlaties().setVisible(true);
            }
        });
    }
